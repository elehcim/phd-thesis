...
\begin{figure}
\centering
\includegraphics[height=0.925\textheight]{{12.1_m_halo_m_star}.pdf}
...
\caption{Velocity dispersion evolution as a function of time normalized with the radial period of the orbit.
}
\label{fig:sigma}
\end{figure}
