...
We also define $t_p: r(t_p)=r_p$ (time of pericenter passage), so that $\tau = (t-t_p)/T_r$ is~0 or 1 for first or second pericenters respectively,~and~0.5 for apocentre passages.
...
\subsubsection{Where do stars form?}
\begin{figure*}
\centering
...
\subsubsection{Central stellar velocity dispersion}
...
\subsection{HI size mass relation during infall}
...
\subsubsection{Angular momentum and specific angular momentum}
...
\subsubsection{Relation with physical angular momentum}
