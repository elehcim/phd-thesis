...
\citet{Venhola2017} found nine UDGs candidates within 4~deg$^2$ from NGC1399.
...
In the size-magnitude parameter space, in Coma UDGs form a continuous distribution, whereas in Fornax two of them are  remarkably luminous, and can be considered as outliers.
...
In fact, if the galaxy gets stripped, it settles up on the early-type branch; if instead they can keep their gas, they turn bluer again on pericenter fall.
...
Only for the 50 kpc orbit its final location is among the early-type galaxies on the C-M diagram.
Dwarfs on wide orbits, as shown in the 300~kpc pericenter panel of Figure~\ref{fig:g-r_sfr}}, stay on the blue branch indefinitely unless they becomes unbound (the condition \eqref{eq:tidal_radius_condition} ceases to be valid), as it happens for the low-mass galaxies.
In Figure~\ref{fig:g-r_sfr} confirms that dwarfs rapidly turn red after quenching.
...
Given that their color evolve rapidly, the gap between the two branch can be explained: an abundance of dwarfs is not expected in the color interval where their evolution is so quick.
