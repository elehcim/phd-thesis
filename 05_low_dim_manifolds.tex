...
\end{subfigure}
\caption{Embedded graph (a) and planar representation (b) of a 2-dimensional manifold extracted from the jellyfish data set. Colorcode is its local curvature distribution.}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{Cylinder.jpg}
