...
\begin{figure}[hb]
  \centering
  \includegraphics[width=\textwidth]{SDSS_filaments_Zehavi2011_Fig1}
  \caption{From \citet{Zehavi2011}, it is shown the SDSS main galaxy sample, with galaxy within $\pm1.25$ deg of the celestial equator, in the north Galactic cap. The large supercluster at z ∼ 0.08, cutting across the center of the Northern cap is the “Sloan Great Wall” the largest coherent structure detected in the SDSS \citep{GottIII2005}.}
  \label{fig:sdss}
\end{figure}
