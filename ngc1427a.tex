...
% \title[A tale of two tails]{A tale of two tails: insights from simulations into the formation of the peculiar dwarf galaxy NGC 1427A}
%[A tale of two tails]{Understanding the formation of gaseous and stellar stripped and tidal tails: insights from dwarf galaxy simulations in a cluster environment}
% \title[A tale of two tails]{Understanding the formation of stripped and tidal tails: insights from dwarf galaxy simulations in a cluster environment}

% \author[M. Mastropietro et al.]{
% M. Mastropietro,$^{1}$\thanks{E-mail: michele.mastropietro@ugent.be}
% S. De Rijcke,$^{1}$
% R. F. Peletier.$^{2}$
% \\
% List of institutions
% $^{1}$Department Physics and Astronomy, Ghent University, Krijgslaan 281, S9, B-9000 Gent, Belgium\\
% $^{2}$Kapteyn Astronomical Institute, University of Groningen, PO Box 800, NL-9700 AV Groningen, the Netherlands\\
% $^{3}$Astronomisches Rechen-Institut, Zentrum f{\"u}ur Astronomie der Universit{\"a}t Heidelberg, M{\"o}onchhofstraße 12-14, 69120 Heidelberg, Germany\\
% }
% 
...
\begin{figure*}
\centering
\includegraphics[width=\textwidth]{NGC1427A.png}
...
\begin{subfigure}[b]{0.33\textwidth}
  \centering
  \includegraphics[width=\textwidth]{NGC_LIKE/r_band_27_5-crop.png}
  \caption{}
  \label{fig:r_band}
\end{subfigure}
% \hfill
...
\begin{subfigure}[b]{0.33\textwidth}
 \centering
 \includegraphics[width=\textwidth]{NGC_LIKE/SB-crop.png}
 \caption{}
 \label{fig:sb_arrows}
\end{subfigure}
 \hfill
  \begin{subfigure}[b]{0.32\textwidth}
  \includegraphics[width=\textwidth]{NGC_LIKE/HI-crop.png}
  \caption{}
...
\begin{subfigure}[b]{0.33\textwidth}
  \centering
  \includegraphics[width=\textwidth]{NGC_LIKE/HI_VEL-crop.png}
  \caption{}
...
The latter is simulated as a single spherically symmetric static NFW potential profile \citep{Navarro1996a} with mass $M~=~10^{14}$~\Msun{} \citep{Drinkwater2001a}:
\begin{equation}
...
\begin{figure}
\centering
\includegraphics[width=0.5\columnwidth]{good_traj-crop.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\columnwidth]{angles-crop.png}
...
\begin{figure*}
\centering
% \includegraphics[width=\textwidth]{histo/hist_all_passage-crop.png}
% \includegraphics[width=\textwidth]{histo/26.5-crop.png}
% \includegraphics[width=\textwidth]{histo/26.5_29bins_3_stacked-crop.png}
% \includegraphics[width=\textwidth]{histo/histo_iso26.5_bins0.35-16-crop.png}
% \includegraphics[width=\textwidth]{histo/hist_first_passage-crop.png}
\caption{BBOX PROBLEMS Histograms of oriented snapshots fulfilling the requirements (i)-(iv), selected to be around first (blue) or second (orange) pericenter and grouped by orbital pericenter distances (50, 100, 150, 200, 300 kpc).
...
\begin{figure*}
\centering
% \includegraphics[width=\textwidth]{histo/iso_comparison_tol15_asym0.0_bins0.35-16-crop.png}
\caption{BBOX PROBLEMS Distribution in time relative to pericenter passage of oriented snapshots fulfilling the requirements (i)-(iv) with tolerance $\delta=15$ deg. Histograms of selected snapshots are coloured relative to their orbital phase: around first (blue) or second (orange) pericenter.
...
\begin{figure}
\centering
\includegraphics[width=0.5\columnwidth]{histo/multi_tol_dist_gauss_bins600_25-crop.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\columnwidth]{histo/multi_tol_vel_angle_bins_gauss90_25-crop.png}
...
\includegraphics[width=\textwidth]{panels/panel68p100-crop.png}
