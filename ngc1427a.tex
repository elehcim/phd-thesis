...
\begin{enumerate}
    ...
    \item[(ii)] the line-of-sight velocity with respect to the cluster centre,~$v_p$;
    \item[(iii)] the position angle of the outer isophotes, quantified as the angle $\alpha$ between the projected cluster centre direction and the direction of the $26.5$~mag/arcsec$^2$ isophote in $r'$ band, see Figure~\ref{fig:angles_scheme};
...
Black arrow indicates the direction to the cluster centre whereas the green indicates the instantaneous velocity direction of the galaxy projected on the plane of the sky. In the first column, an ellipse fitted on the $26.5$ mag/arcsec$^2$ is shown to highlight the direction of the tidal elongation.
...
M.M. thanks F. D'Eugenio and A. Nersesian for insightful discussions.
