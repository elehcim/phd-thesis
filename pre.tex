...
We carried out simulations of the evolution of several dwarf galaxies falling into a Fornax-like Cluster.
...
We have been interested in following the journey of the galaxies into the cluster and characterize their size, star formation rates, gas dark matter content, stellar dynamics and evolution depending on the orbit and the initial mass at the time of orbital injection.
To do so, we adapted the Moving Box simulation technique to our in-house code.
This allows to obtain a high resolution dwarf-cluster interaction while keeping an affordable simulation run time.

We found that during infall, generally, galaxies will undergo some ``phase transitions" which will happen mainly at pericenter passages.
Some of the galaxies will effectively be transformed into Ultra Diffuse Galaxies (UDG), some others will be allowed to be briefly identified as ``jellyfish".
It is therefore possible to hypothesize that the jellyfish phenomenon is a relatively short transitory phase of the galaxy along its orbit, and its likely a precursor of the transformation of a dwarf galaxy into an UDG.
%We also linked properties of the UDGs .
...
For this galaxy multiple formation scenarios have been proposed, but a consensus is still lacking in the literature.
We identified that gaseous and stellar tails pointing in different directions are explainable given that they are subject to different environmental effects.
This finds support in our simulations and developed a procedure to quantitatively assess properties of simulated galaxies from a catalogue of simulations.
...
Finally, we contributed to the development of a technique to study low dimensional manifolds in the.
