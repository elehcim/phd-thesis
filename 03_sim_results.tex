...
In particular, the \Hi{} fraction of a gas particle is computed based on tabulated data from \citet{DeRijcke2013} as a function of:
...
The snapshots have been oriented following the assumption that the line-of-sight lies on the plane of the orbit of the galaxy.
...
In other words, the surface density of \Hi{} is constant not only among different galaxies but also over time when the galaxy undergoes stripping.
