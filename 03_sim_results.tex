...
Some of the galaxies will effectively be transformed into Ultra Diffuse Galaxies (as shown in Section~\ref{sec:UDG}), some others will be allowed to be briefly identified as ``jellyfish" (Section~\ref{sec:where_star_formation}).
...
UDGs are therefore defined as large ($R_e > 1.5$~kpc) low surface brightness galaxies.
...
The cluster alignment of UDGs is also a quantity which in various clusters has been measured.
...
While stars gets formed around pericenter passages, dark matter instead is pulled out by tidal forces which elongate the halo, effectively stripping dark-matter particles out of the moving box of our simulation setup.
...
%Moreover, inspection of the evolution of the direction of the principal axes of the stellar density distribution along a simulated dwarf galaxy's orbit shows that the galaxy outskirts rapidly forget their initial spatial orientation and become strongly aligned with the cluster centre around pericenter and apocenter. We provide a small animation to demonstrate this (Attachment 1, relative to ID 69, pericenter of 100 kpc). On the inward or outbound legs of their orbits, this elongation occurs parallel with a galaxy's orbital velocity. This evidence for a tight correlation between a dwarf galaxy's elongation and its orbital phase, led us to include criterion
...
However, the star particles lost during the orbit (\ie{} going out of the Moving Box), leads to an underestimation (of a maximum of 30\% for the most recent bins especially on low mass galaxies on radial orbits) of what has actually happened during the galaxy journey around the cluster.
This is especially true for star particles formed in the tail of the infalling galaxies: these particles at the time of creation have the same velocity as the stripped gas, which makes them travel away from the simulation box.
