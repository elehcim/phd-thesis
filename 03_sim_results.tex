...
In their formal exposition, they describe the approximations made to relate $\lambda_R$ (which is obtained by the observed properties of the galaxy as measured from the Earth point of view) to the spin parameter~$\lambda$ \citep[p. 757]{BinneyTremaine2008}:
\begin{equation}
...
All in all these four coefficients grasp the effects of projection and of the luminous and mass distributions:
\begin{equation}
  \left\{
  \begin{array}{cl}
