...
MoRIA models \citet{Verbeke2017}
\subsection{Gravity}
...
\begin{figure}[h]
 ...
 \caption{An illustration of a full fledged simulation of a dwarf galaxy with a Fornax-like cluster. The gas density is color coded \citep[using the \texttt{glnemo2} software][]{Lambert2012}. Note the number of particles involved, almost 2 millions.
