...
For completeness we introduce briefly quaternions algebra

\paragraph{Critically damped oscillator}
...
\caption{Adoc acceleration of the simulation ID 69 with pericenter 200.}
\label{fig:adhoc}
\end{figure}
