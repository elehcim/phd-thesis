...
With a slight abuse of notation we will write $\vec x' = \bar{\vect q}\, \vec x \, \vect q$ or directly $\vect x' = \bar{\vect q}\, \vect x \, \vect q$, given that it will be clear from the context what is a quaternion (mainly just $\vect q$).
