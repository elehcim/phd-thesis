...
They have a virial mass of $M_{200}\approx 10^{10} - 10^{11}$\Msun{}.
The dark particle mass is $m_{\mathrm{dm}} = 2 \cdot 10^4$ \Msun{}.
The baryonic particle mass $m_{\mathrm{b}}$ follows from the relation $\Omega_\mathrm{b}/\Omega_{\mathrm{dm}} = 0.2115$ \citep{Planck2015}.
Number of particles $n_\mathrm{b} = n_{\mathrm{dm}} = 5 \cdot 10^5 - 2 \cdot 10^6$ \Msun{}.
They have been simulated using the merger tree technique...
\subsection{Gravity}
