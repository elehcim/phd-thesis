...
From this, $\vect \Omega$ can be computed as $\vect{\Omega} = {(\Vp\times\Ap)}/{\Vp^2}$ and the angular velocity of the box w.r.t. the rotating frame simply as $\vect \omega = \mathbf q^{-1}\, \vect \Omega\, \mathbf q $.
